...
class TestOrders(unittest.TestCase):
    ...
    def test_get_items_in_order(self):
        order = self.orders.data[0]
        self.assertEqual(self.orders.get_items_in_order(order["id"]),
                         order["items"])
    ...
    def test_get_orders_in_shipment(self):
        ...
        self.assertIn(order["id"],
                      self.orders.get_orders_in_shipment(shipment_id))
    ...
    def test_update_order(self):
        ...
        self.assertEqual(self.orders.get_order(order["id"])["status"],
                         "Updated")
    ...
    def test_update_orders_in_shipment(self):
        ...
        self.assertIn(self.orders.data[0]["id"],
                      self.orders.get_orders_in_shipment(shipment_id))
