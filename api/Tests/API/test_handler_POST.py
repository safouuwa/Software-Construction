...
class TestApiHandlerPOST(unittest.TestCase):
    ...
    def test_create_client(self):
        ...
        response = httpx.get(f"{BASE_URL}/clients/{new_client['id']}", headers=self.headers)
    ...
    def test_create_inventory(self):
        ...
        response = httpx.get(f"{BASE_URL}/inventories/{new_inventory['id']}", headers=self.headers)
        self.assertEqual(response.status_code, 200)
    ...
    def test_create_item(self):
        ...
        response = httpx.get(f"{BASE_URL}/items/{new_item['uid']}", headers=self.headers)
        self.assertEqual(response.status_code, 200)
        created_item = json.loads(response.text)
        self.assertEqual(created_item['uid'], new_item['uid'])
    ...
    def test_create_location(self):
        ...
        response = httpx.get(f"{BASE_URL}/locations/{new_location['id']}", headers=self.headers)
        self.assertEqual(response.status_code, 200)
    ...
    def test_create_order(self):
        ...
        response = httpx.get(f"{BASE_URL}/orders/{new_order['id']}", headers=self.headers)
        self.assertEqual(response.status_code, 200)
    ...
    def test_create_shipment(self):
        ...
        response = httpx.get(f"{BASE_URL}/shipments/{new_shipment['id']}", headers=self.headers)
        self.assertEqual(response.status_code, 200)
    ...
    def test_create_supplier(self):
        ...
        response = httpx.get(f"{BASE_URL}/suppliers/{new_supplier['id']}", headers=self.headers)
        self.assertEqual(response.status_code, 200)
    ...
    def test_create_transfer(self):
        ...
        response = httpx.get(f"{BASE_URL}/transfers/{new_transfer['id']}", headers=self.headers)
        self.assertEqual(response.status_code, 200)
    ...
    def test_create_warehouse(self):
        ...
        response = httpx.get(f"{BASE_URL}/warehouses/{new_warehouse['id']}", headers=self.headers)
        self.assertEqual(response.status_code, 200)
